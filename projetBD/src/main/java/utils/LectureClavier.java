...
/**
 *
 * Cette classe a pour role de faciliter la lecture de donnees a partir du
 * clavier. <BR>
 * Elle definit une methode de lecture pour les types de base les plus
 * courramment utilises (int, float, double, boolean, String).<BR>
 * <BR>
 * La lecture d'une valeur au clavier se fait en tapant celle-ci suivie d'un
 * retour chariot. <BR>
 * En cas d'erreur de lecture (par exemple un caractere a ete tape lors de la
 * lecture d'un entier) un message d'erreur est affiche sur la console et
 * l'execution du programme est interrompue. <BR>
 * <BR>
 * <BR>
...
public class LectureClavier {
	 ...
	 * (System.out) un message indiquant le type de l'erreur ainsi que la pile
	 * des appels de methodes ayant conduit a cette erreur.
	 * 
	 * @param e
	 *            l'exception decrivant l'erreur.
	 * @param message
	 *            le message d'erreur a afficher.
	 */
